...
## 1. 配置项范围
编号	配置项名称	说明	存储位置
CP-01	README.md	项目背景、团队分工、目录说明、分支说明	/ 根目录
CP-02	项目启动说明	需求概述、技术选型、角色分工表	/docs/01-project-charter.md
CP-03	WBS 文档	工作分解结构（至少L3级）	/docs/02-wbs.md
CP-04	进度计划文档	简化进度计划表（含工期、前置、责任人）	/docs/03-schedule.md
CP-06	示例代码/资源文件	报名/签到核心逻辑示例、UI原型资源	/src/、/assets/
